...
def main():
    ...
    with st.container():
        ...
        st.write('Please Connect this app to your cytology lab to help diagnose breast cancer from your tissue sample. This app predicts using a machine learning model whether a breast mass is benign or malignant based on the measurments it receives from your cytosis lab. you can also update the measurments by hand using the sliders in the sidebar')
